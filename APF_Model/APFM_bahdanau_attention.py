...
tx = 10
ty = 1
train_x, train_y, test_x, test_y, minimax_scaler = utils.get_data_attention('pollution.csv', 8, tx, ty)
no_features = 8
# print(X)
# print('\n')
# print(Y)
...
history = model.fit([train_x, s0, c0], outputs, epochs=50, batch_size=72,
