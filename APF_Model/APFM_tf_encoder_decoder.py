...
x_train = df_train.loc[:, ['pollution', 'dew', 'temp', 'press', 'wnd_spd', 'snow', 'rain',
                           'wnd_dir_NE', 'wnd_dir_NW', 'wnd_dir_SE', 'wnd_dir_cv']].values.copy()
...
temp = [test_y[i].reshape(-1) for i in range(0, test_y.shape[0], 5)]
...
plt.savefig("APFM_tf_enc_dec_predicted_vs_actual.png")
